...
* [soggy - built with res](https://cdn.discordapp.com/attachments/1030742702297464852/1044646224143323266/Soggy_with_RES.rar) or [normal soggy](https://github.com/LDAsuku/soggy) and [soggy_resources](https://codeberg.org/LDA_suku/soggy_resources)
...
<Callout emoji="⚠️" type="warning">
   **NOTE**
   If the one with built res doesn't work, use [manual building](./CBT#manual-building).
</Callout>
...
```
After putting that in fiddler, save it and open *anime game*
